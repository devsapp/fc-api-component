        ...
        if (this.comParse['data'] && this.comParse['data'].help) {
            ...
            if (this.apiContent[this.comParse['data']['_'][0]]) {
                ...
                const tempOptions = {
                    ...
                    optionList: [{
                        name: 'region',
                        description: `[Required] Specify the fc region, value: cn-hangzhou/cn-beijing/cn-hangzhou/cn-shanghai/cn-qingdao/cn-zhangjiakou/cn-huhehaote/cn-shenzhen/cn-chengdu/cn-hongkong/ap-southeast-1/ap-southeast-2/ap-southeast-3/ap-southeast-5/ap-northeast-1/eu-central-1/eu-west-1/us-west-1/us-east-1/ap-south-1\n* Set default region: [s cli fc-default set api-default-region <region>]`,
                        type: String,
                    }, {
                        name: 'access',
                        alias: 'a',
